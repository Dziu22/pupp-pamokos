...
export const works: Work[] = [
  ...
  },
  {
    ...
    situation: "Dorianas trokšta likti amžinai jaunas ir gražus. Jo portretas rodo moralinį nuopuolį, o pats Dorianas vis labiau renkasi ydų kelią.",
    ...
    sampleArgument: "Oskaro Vaildo romane Dorianas pats renkasi ydų kelią, todėl jo pražūtį lemia ne portretas, o moralės atsisakymas.",
    commonMistakes: "Dorianas blogėja ne dėl paveikslo. Jis pats renkasi ydų kelią.",
    argumentBank: {
